...
public class MISApplet extends Applet implements Runnable {
    ...
    public int pack(double red, double grn, double blu) {
    ...
    int clip(double t, int lo, int hi) { return (int) (t<lo ? lo : t>hi ? hi : t); }
